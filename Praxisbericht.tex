...
\newcommand{\studiengang}{International Business Administration and Information Technology}
...
\include{Inhalt/04_Inhalt/01_Einfuehrung}
\include{Inhalt/04_Inhalt/02_Beispiele}
\include{Inhalt/04_Inhalt/03_RisikenProbleme}
